<div class="row">
	<div class="panel panel-info">
  		<div class="panel-heading incountry">
   			<h3 class="panel-title">DU LỊCH TRONG NƯỚC
    			...
    			<ul class="list-group">
    				<?php foreach ($tour_region as $key => $value) {
    					if ($value['tour_country_code'] == '1') {
    						echo '<li class="list-group-item"><a href="index.php?controller=tour&amp;action=region&amp;tour_region_code='.$value['tour_region_code'].'">'.$value['tour_region_name'].'</a></li>';
    					}
    				} ?>
    			</ul>  				
  			</div>
...
<div class="row">
	<div class="panel panel-info">
  		<div class="panel-heading outcountry">
   			<h3 class="panel-title">DU LỊCH NƯỚC NGOÀI
   				<b class="glyphicon glyphicon-plus-sign visible-xs pull-right"></b>
   			</h3>
