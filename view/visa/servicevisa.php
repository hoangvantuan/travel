				                ...
				                <li class="list-group-item">
	                    			...
	                    			<div class="col-md-9">
				                        ...
				                        <h4 class="list-group-item-heading"><i class="fa fa-cc-visa"></i>
				                        	<a href="index.php?controller=visa&action=servicevisa&passport_visa_code=<?php echo $value['passport_visa_code'];?>&pass_offer=<?php echo $value['passport_visa_offer_code'];?>"><?php echo $value['title'];?></a></h4>
